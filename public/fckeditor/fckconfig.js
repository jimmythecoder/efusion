...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','Underline','-','UnorderedList','-','Link','Unlink','-','Image','Style']
] ;

FCKConfig.ToolbarSets["efusion"] = [
	['Source','-','Templates','Cut','Copy','Paste','PasteText','PasteWord','Undo','Redo','Find','Replace','SelectAll','RemoveFormat'],
	'/',
