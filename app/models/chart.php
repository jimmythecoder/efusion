...
class chart
{
   ...
   /** 
    * constructor Create an chart object.
    *
    ...
    */
    function chart()
    {
         register_shutdown_function(array(&$this, '_chart'));
         
         $this->graphWidth = CHART_WIDTH;
         $this->graphHeight = CHART_HEIGHT;
         $this->textPadding = 3;
         $this->yTicks = 10;
         $this->yNumberFormat = '';
         $this->yValueMode = 3;
    ...
    */
	...
	function save_graph_as_image($path_and_filename)
	{
		ImagePNG($this->img,$path_and_filename);
	}
