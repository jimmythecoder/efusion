...
#  * @var               string TITLE
#  */
TITLE="eFusion ecommerce documentation"
...
#  */
PATH_PROJECT=/var/www/new.efusion.co.nz/app

#/** 
#  * name of a directory(s) to ignore directory1,directory2
#  */
IGNORE=/var/www/new.efusion.co.nz/app/core/smarty/
...
#  */
PATH_PHPDOC=/var/www/new.efusion.co.nz/docs/phpdoc/phpdoc
...
#  */
PATH_DOCS=/var/www/new.efusion.co.nz/docs/code
...
# make documentation
$PATH_PHPDOC -d $PATH_PROJECT -t $PATH_DOCS -i $IGNORE -ti "$TITLE" -dn $PACKAGES \
